...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="{{id}}">
  <a class="navbar-brand" href="/">
    <img data-src="/thumb/100x50/src/{{_sett.logo.0.img}}" class="img-fluid" wb-if="'{{_sett.logo.0.img}}'>''">
    <svg class="mi mi-home-circle size-50 img-fluid" stroke="000047" wb="module=myicons" wb-if="'{{_sett.logo.0.img}}' == ''"></svg>
  </a>

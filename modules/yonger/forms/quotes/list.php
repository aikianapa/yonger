...
<div class="m-3" id="yongerQuotes">
        ...
        <a href="#" data-ajax="{'url':'/cms/ajax/form/quotes/edit/_new','html':'#yongerQuotes modals'}" class="ml-auto order-2 float-right btn btn-primary">
    ...
    <tbody>
        <wb-foreach wb="table=quotes&sort=_created:d&bind=cms.list.quotes" wb-filter="{'login':'{{_sess.user.login}}' }">
            <tr>
                ...
                <td>{{status}}</td>
                <td>
                    <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/quotes/edit/{{id}}','html':'#yongerQuotes modals'}" class="d-inline">
                    <img src="/module/myicons/content-edit-pen.svg?size=24&stroke=323232">
                    </a>
                    <a href="javascript:" data-ajax="{'url':'/ajax/rmitem/quotes/{{id}}','update':'cms.list.quotes','html':'#yongerQuotes modals'}"  class="d-inline">
